////[https://hl7.org/fhir/r4b](https://hl7.org/fhir/r4b) r4b search params
...
pub type Nutritionproduct {
  Nutritionproduct(identifier: Option(String), status: Option(String))
}
...
pub fn administrableproductdefinition_new() {
  Administrableproductdefinition(None, None, None, None, None, None, None, None)
}
...
pub fn ingredient_new() {
  Ingredient(None, None, None, None, None, None, None, None)
}
...
pub fn manufactureditemdefinition_new() {
  Manufactureditemdefinition(None, None, None)
}
...
pub fn subscriptiontopic_new() {
  Subscriptiontopic(None, None, None, None, None, None, None, None, None)
}
